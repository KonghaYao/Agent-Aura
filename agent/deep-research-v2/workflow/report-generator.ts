...
2. **Citations**: You MUST preserve the original citation numbers (e.g., [1], [5]) when you use the information.
   - If you combine info from source [1] and [2], cite them as [1][2].
   - Do not re-number citations. Keep the original numbers from the input text so they match the reference list.
